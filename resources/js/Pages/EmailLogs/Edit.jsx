...
export default function EmailLogsEdit({ emailLog }) {
    const { data, setData, put, processing, errors } = useForm({
        ...
        sent_at: toDateTimeInput(emailLog?.sent_at),
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        put(`/email-logs/${emailLog.id}`);
    };

    return (
        <DashboardLayout title="Edit Email Log">
            <div className="max-w-2xl">
                ...
                <form onSubmit={handleSubmit} className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6 space-y-5">
                    ...
                    <div className="flex gap-3 pt-2">
                        ...
                        >
                            {processing ? 'Updating...' : 'Update Email Log'}
                        </button>
