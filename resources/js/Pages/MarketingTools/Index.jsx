...
export default function OrderManagementIndex({
    ...
    const navigate = (params = {}) => {
        router.get(
            route(activeConfig.routes.index),
            {
                search,
                per_page: perPage,
                ...params,
    ...
    const submit = (e) => {
        ...
        if (editingId) {
            put(route(activeConfig.routes.update, { id: editingId }), {
                preserveScroll: true,
        ...
        post(route(activeConfig.routes.store), {
            preserveScroll: true,
            onSuccess: () => {
                reset();
                setData(buildDefaultState(fields));
    ...
    const handleDelete = (id) => {
        ...
        router.delete(route(activeConfig.routes.destroy, { id }), {
            preserveScroll: true,
        });
    };
            ...
            <div className="space-y-6">
                <div className="rounded-2xl border border-gray-200 dark:border-slate-700 bg-white dark:bg-slate-900 p-4">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
                        Manage coupons, flash sales, bundles, banners, announcements, and newsletter tools from one place.
                    </p>
                                ...
                                <div key={field.name}>
                                    ...
                                    {field.type === 'select' ? (
                                        ...
                                        >
                                            ...
                                            {!field.choices && (lookups[field.options] || []).map((option) => (
