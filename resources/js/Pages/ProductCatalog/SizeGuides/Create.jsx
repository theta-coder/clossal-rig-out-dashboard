...
export default function SizeGuidesCreate({ categories }) {
    const { data, setData, post, processing, errors } = useForm({
        name: '',
        category_id: '',
        columns: ['Size', 'Chest', 'Length', 'Shoulder', 'Sleeve'],
        rows: [
            { size_label: 'S', measurements: { 'Chest': '', 'Length': '', 'Shoulder': '', 'Sleeve': '' } }
        ],
    });
    ...
    const handleSubmit = (e) => {
        e.preventDefault();
        post(route('size-guides.store'));
    };

    return (
        <DashboardLayout title="Create Size Guide">
            <Head title="New Size Guide" />
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                placeholder="e.g. Men's Shirts Size Chart"
                            />
                ...
                <div className="flex justify-end pt-4">
                    ...
                    >
                        <HiOutlineSave className="w-5 h-5" /> {processing ? 'Creating Chart...' : 'Create Size Guide'}
                    </button>
                </div>
            </form>
        </DashboardLayout>
