...
class ProductController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return Inertia::render('ProductCatalog/Products/Index');
    }
    ...
    {
        return Inertia::render('ProductCatalog/Products/Create', [
            'categories' => Category::where('is_active', true)->get(['id', 'name']),
            'available_sizes' => Size::orderBy('name')->get(['id', 'name']),
            'available_colors' => Color::orderBy('name')->get(['id', 'name', 'code']),
            'available_tags' => Tag::orderBy('name')->get(['id', 'name']),
            'available_collections' => Collection::orderBy('name')->get(['id', 'name']),
        ]);
    }
    ...
    {
        return Inertia::render('ProductCatalog/Products/Edit', [
            'product' => $product->load(['images', 'sizeAttributes', 'colorAttributes', 'details', 'tags:id,name', 'collections:id,name']),
            'categories' => Category::where('is_active', true)->get(['id', 'name']),
            'available_sizes' => Size::orderBy('name')->get(['id', 'name']),
            'available_colors' => Color::orderBy('name')->get(['id', 'name', 'code']),
            'available_tags' => Tag::orderBy('name')->get(['id', 'name']),
    ...
    {
        return Inertia::render('ProductCatalog/Products/Show', [
            'product' => $product->load(['category', 'images', 'sizes', 'colors', 'details', 'tags', 'collections', 'reviews.user']),
        ]);
    }
